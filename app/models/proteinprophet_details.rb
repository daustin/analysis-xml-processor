class ProteinprophetDetails
  ...
  property :id, Serial
  property :occam_flag, String, :length => (0..2000)
  property :groups_flag, String, :length => (0..2000)
  property :degen_flag, String, :length => (0..2000)
  property :nsp_flag, String, :length => (0..2000)
  property :initial_peptide_wt_iters, Integer
  property :nsp_distribution_iters, Integer
  property :final_peptide_wt_iters, Integer
  property :run_options, String, :length => (0..2000)
