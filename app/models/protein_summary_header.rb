class ProteinSummaryHeader
  ...
  property :id, Serial
  property :reference_database, String, :length => (0..1000)
  property :residue_substitution_list, String, :length => (0..1000)
  property :source_files, String, :length => (0..1000)
  property :source_files_alt, String, :length => (0..1000)
  ...
  property :sample_enzyme, String, :length => (0..1000)
